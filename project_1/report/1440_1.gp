...
set output "1440_1.eps"
set title "N=1440 Cores=1"
...
plot "1440_1.aggregated" u ($1):($5) with lines linestyle 1 title "total time",      "1440_1.aggregated" u ($1):($2) with lines linestyle 2 title "init time",      "1440_1.aggregated" u ($1):($3) with lines linestyle 3 title "send time",      "1440_1.aggregated" u ($1):($4) with lines linestyle 4 title "compute time", 