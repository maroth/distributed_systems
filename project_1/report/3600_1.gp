...
set output "3600_1.eps"
set title "N=3600 Cores=1"
...
plot "3600_1.aggregated" u ($1):($5) with lines linestyle 1 title "total time",      "3600_1.aggregated" u ($1):($2) with lines linestyle 2 title "init time",      "3600_1.aggregated" u ($1):($3) with lines linestyle 3 title "send time",      "3600_1.aggregated" u ($1):($4) with lines linestyle 4 title "compute time", 