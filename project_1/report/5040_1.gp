...
set output "5040_1.eps"
set title "N=5040 Cores=1"
...
plot "5040_1.aggregated" u ($1):($5) with lines linestyle 1 title "total time",      "5040_1.aggregated" u ($1):($2) with lines linestyle 2 title "init time",      "5040_1.aggregated" u ($1):($3) with lines linestyle 3 title "send time",      "5040_1.aggregated" u ($1):($4) with lines linestyle 4 title "compute time", 