...
set output "1152_4.eps"
set title "N=1152 Cores=4"
...
plot "1152_4.aggregated" u ($1):($5) with lines linestyle 1 title "total time",      "1152_4.aggregated" u ($1):($2) with lines linestyle 2 title "init time",      "1152_4.aggregated" u ($1):($3) with lines linestyle 3 title "send time",      "1152_4.aggregated" u ($1):($4) with lines linestyle 4 title "compute time", 