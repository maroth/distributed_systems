...
set output "2304_1.eps"
set title "N=2304 Cores=1"
...
plot "2304_1.aggregated" u ($1):($5) with lines linestyle 1 title "total time",      "2304_1.aggregated" u ($1):($2) with lines linestyle 2 title "init time",      "2304_1.aggregated" u ($1):($3) with lines linestyle 3 title "send time",      "2304_1.aggregated" u ($1):($4) with lines linestyle 4 title "compute time", 